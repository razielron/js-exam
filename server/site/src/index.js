class HomePage extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({search: this.state.search, g_movies: random_movies})
  }

  render() {
    return <div id='homepage'>
      <input type='text' placeholder='search for a movie name...' value={this.state.search} onChange={this.searchChange}></input>
      <button onClick={this.searchMovie}>search</button>
      <MovieList g_movies={this.state.g_movies}></MovieList>
    </div>
  }
}